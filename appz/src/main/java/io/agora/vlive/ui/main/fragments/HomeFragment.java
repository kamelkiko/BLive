...
public class HomeFragment extends AbstractFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int tabId;
        int id = view.getId();
        if (id == R.id.home_category_single_layout) {
            tabId = Global.Constants.TAB_ID_SINGLE;
        } else if (id == R.id.home_category_pk_layout) {
            tabId = Global.Constants.TAB_ID_PK;
        } else if (id == R.id.home_category_virtual_host_layout) {
            tabId = Global.Constants.TAB_ID_VIRTUAL;
        } else if (id == R.id.home_category_ecommerce_layout) {
