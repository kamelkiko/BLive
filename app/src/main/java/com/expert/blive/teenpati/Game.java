...
public class Game extends AppCompatActivity {
    ...
    public static DatabaseReference databaseReferenceParent = database.getReference("userss");
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        if (document.get("Limit") != null) {
                            ...
                            if (TE >= Lim) {
                                Toast.makeText(getApplicationContext(), "You have exceeded today's game limit.", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chip100.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (UserCoins == 0) {
                    Toast.makeText(Game.this, "Add Coin First ", Toast.LENGTH_SHORT).show();
                } else {
                    if (BetAllow) {
        ...
        ImageButton BBirdButton = findViewById(R.id.app_logoChair);
...
//                    BirdMasks[2].setVisibility(View.INVISIBLE);
                    ...
                    if (BETAllowed(0)) {
                        ...
                        if (CV.CoinValues(CV) == 0) {
                            Toast.makeText(Game.this, "Select Amount First", Toast.LENGTH_SHORT).show();
                        } else {
...
//                        BetArea(0, CV.CoinValues(CV));
                        ...
                        Toast.makeText(Game.this, "MAx 2 Pot Selection only", Toast.LENGTH_SHORT).show();
                    }
        ...
        ImageButton PBirdButton = findViewById(R.id.app_logoChair);
...
//                        BetArea(1, CV.CoinValues(CV));
        ...
        ImageButton RBirdButton = findViewById(R.id.app_logoChair);
...
//                    BirdMasks[2].setVisibility(View.VISIBLE);
        ...
        RulesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Game.this, Rules.class);
                startActivity(i);
            }
        });
        ...
        Histry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Game.this, History.class);
                startActivity(i);
            }
        });
...
//        if (increment > 0) {
//            new MvvmViewModelClass().spinOneModalLiveData(Game.this, CommonUtils.getUserId(), String.valueOf(increment), "0").observe(Game.this, new Observer<SpinOneModal>() {
//                @Override
//                public void onChanged(SpinOneModal addPurchaseCoin) {
//                    Toast.makeText(Game.this, "" + addPurchaseCoin.getMessage(), Toast.LENGTH_SHORT).show();
//                }
//            });
//        }
//    }
...
//                        long PotC = (long) 1000;
                        ...
                        Toast.makeText(Game.this, "ss" + WinnedPot, Toast.LENGTH_SHORT).show();
...
//                            StartTimer(30);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Game.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
...
//        if (PrizeCoins > 0) {
//            new MvvmViewModelClass().spinOneModalLiveData(Game.this, CommonUtils.getUserId(), String.valueOf(prizeCoins), "1").observe(Game.this, new Observer<SpinOneModal>() {
//                @Override
//                public void onChanged(SpinOneModal addPurchaseCoin) {
//                    Toast.makeText(Game.this, "" + addPurchaseCoin.getMessage(), Toast.LENGTH_SHORT).show();
//                }
...
//    }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (snapshot != null && snapshot.exists()) {
                        ...
                        Toast.makeText(Game.this, "" + MyPots.size(), Toast.LENGTH_SHORT).show();
    ...
    void    checkForTimerTwo(){
        databaseReferenceParent.child("timer").setValue(30);

        databaseReferenceParent.child("timer").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    int Timerr = snapshot.getValue(Integer.class);
                    for (int a = 0; a <= Timerr; a++) {
                        Handler handler1 = new Handler();
                        int AA = a;
                        handler1.postDelayed(new Runnable() {
...
//                                Map<String, Object> TestD = new HashMap<>();
//                                TestD.put("timer", Timerr - AA);
                                databaseReferenceParent.child("timer").setValue(Timerr - 1);
//                                startButton.setVisibility(View.GONE);
    ...
    void CheckforTimer() {
        ...
        listenerRegdoc = docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException error) {
                if (error != null) {
                    Log.w("TAGError", String.valueOf(error));
                    Toast.makeText(Game.this, "wedwe", Toast.LENGTH_SHORT).show();
