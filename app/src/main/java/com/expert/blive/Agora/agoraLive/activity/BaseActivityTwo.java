...
public abstract class BaseActivityTwo extends AppCompatActivity implements EventHandler {
    private final static Logger log = LoggerFactory.getLogger(BaseActivityTwo.class);
    protected DisplayMetrics mDisplayMetrics = new DisplayMetrics();
    protected int mStatusBarHeight;

    BaseActivityTwo instace;
    ...
    protected abstract void onGlobalLayoutCompleted();
    ...
    protected RtcEngine rtcEngine() {
        return application().rtcEngineAudio();
    }
     ...
     * @param elapsed Time elapsed (ms)
    from the local user calling the joinChannel method until this callback is triggered.
     */
    @Override
     ...
     * @param uid User ID.
     * @param elapsed Time elapsed (ms)
    from the user calling joinChannel until this callback is triggered.
     */
    @Override
     ...
     * @param elapsed Time delay (ms)
    from the local user calling joinChannel/setClientRole until this callback is triggered.
     */
    @Override
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        ...
        Log.d("onRemoteAudioStats", "onRemoteAudioStats: "+stats.audioLossRate);
