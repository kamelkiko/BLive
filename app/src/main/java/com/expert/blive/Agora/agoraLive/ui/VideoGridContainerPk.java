...
public class VideoGridContainerPk extends RelativeLayout implements Runnable {
    ...
    public VideoGridContainerPk(Context context) {
        super(context);
        init();
    }
    ...
    public VideoGridContainerPk(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VideoGridContainerPk(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        setBackgroundResource(R.drawable.bg_pk);
