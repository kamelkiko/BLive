...
import com.expert.blive.databinding.FragmentCountBinding;
import com.expert.blive.mvvm.MvvmViewModelClass;
import com.expert.blive.utils.CommonUtils;

public class Fragment_Count extends Fragment {
    FragmentCountBinding binding ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCountBinding.inflate(getLayoutInflater(), container, false);
    ...
    private void setData() {
        ...
        viewModelClass.get_vips(CommonUtils.getUserId(),"2").observe(requireActivity(), new Observer<VipRoot>() {
            @Override
