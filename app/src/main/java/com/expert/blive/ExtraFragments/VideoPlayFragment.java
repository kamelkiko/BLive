...
import com.expert.blive.ModelClass.Video.ShareVideoDetails;
...
public class VideoPlayFragment extends Fragment implements Player.EventListener {

    private HttpProxyCacheServer proxy;
    public static SimpleExoPlayer previous_player;
    private PlayerView video_player;
    private ImageView back_chat;
    private ShareVideoDetails shareVideoRoot;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        proxy = getProxy();
        shareVideoRoot = (ShareVideoDetails) getArguments().getSerializable("key");
        String proxyUrl = proxy.getProxyUrl(shareVideoRoot.getVideoPath());
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(requireActivity(),
                Util.getUserAgent(requireActivity(), "B Live"));
    ...
    private void onClicks() {
        ...
        back_chat.setOnClickListener(view -> requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.main_frame_layout,new ChatFragment()).addToBackStack(null).commit());
