...
import com.expert.blive.ModelClass.VideoUsersInfo;

import java.io.Serializable;

public class VideoDetail2 implements Serializable {
    public String id;
    ...
    public VideoUsersInfo usersInfo;
    ...
    public VideoUsersInfo getUsersInfo() {

        return usersInfo;
    }

    public void setUsersInfo(VideoUsersInfo usersInfo) {
